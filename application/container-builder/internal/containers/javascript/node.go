...
func BuildNodeContainer() {

	// TODO: Build awesome node container
	// TODO: build dockerfile reference to help understand what to do here
	var opt buildOpt
...
func goBuildBase() llb.State {
	goAlpine := llb.Image("docker.io/library/node:current-alpine3.17")
	return goAlpine.
